...
def test_sample():
    ...
    new_topic = _learn._sample(tstamp_idx, hyper, source, dest, \
            ...
            count_z, .1, .1, .1, prob_topics_aux, kernel)
...
def test_estep():
    ...
    new_state = _learn._e_step(tstamps, Trace, previous_stamps, 
            Count_zh, Count_sz, Count_dz, count_h, count_z, alpha_zh, \
            beta_zs, beta_zd, prob_topics_aux, kernel)
...
def test_em():
    ...
    _learn.em(tstamps, Trace, previous_stamps, 
            Count_zh, Count_sz, Count_dz, 
            count_h, count_z, alpha_zh, beta_zs, beta_zd,
            prob_topics_aux, Theta_zh, Psi_sz, Psi_dz, 10, 2, kernel)
